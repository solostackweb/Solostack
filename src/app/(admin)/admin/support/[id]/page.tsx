    ...
    <AdminSection className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_280px]">
        ...
        <div className="space-y-3">
          <div className="space-y-3 rounded-lg border bg-card p-4 shadow-sm shadow-black/[0.03]">
            {messages.length === 0 ? (
              ...
              messages.map((m) => {
                if (m.is_internal_note) {
                  return (
                    <div key={m.id} className="rounded-lg border border-warning-subtle bg-warning-subtle p-3">
                      <div className="mb-0.5 text-micro font-semibold uppercase tracking-wide text-warning-strong">
                ...
                return (
                  <div key={m.id} className={cn("flex", fromCustomer ? "justify-start" : "justify-end")}>
                    <div className={cn(
                      ...
                      <div className="mb-0.5 text-micro font-medium uppercase tracking-wide text-muted-foreground">
        ...
        <aside className="space-y-4">
          ...
          <Panel title="Customer" className="p-4">
            ...
            {context.userId ? (
              ...
              <p className="mt-3 text-xs text-muted-foreground">Guest (no account)</p>
            )}
          </Panel>
        </aside>
      </div>
