  ...
  return (
    <section className="border-t bg-muted/30">
      <Reveal className="mx-auto flex w-full max-w-[1600px] flex-col items-center justify-between gap-5 px-5 py-10 text-center sm:px-8 sm:py-12 lg:flex-row lg:px-12 lg:text-left 2xl:px-16">
        <div>
          <h2 className="font-display text-2xl font-semibold tracking-tight text-foreground sm:text-2xl">
        ...
        <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
          <Button asChild size="lg" className="btn-gradient h-12 min-w-[180px] rounded-full border-0 text-sm font-semibold">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="h-12 min-w-[140px] rounded-full text-sm hover:border-primary/40 hover:bg-primary/5"
          >
